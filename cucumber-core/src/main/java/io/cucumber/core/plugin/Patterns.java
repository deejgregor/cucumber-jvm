...
public class Patterns {
    ...
    private static final String IP_ADDRESS_STRING = "((25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9])\\.(25[0-5]|2[0-4]"
            + "[0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1]"
            + "[0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}"
            + "|[1-9][0-9]|[0-9]))";

    /**
     * Kept for backward compatibility reasons. It does not match IPv6
     * addresses.
     *
     * @deprecated Please use
     *             {@link android.net.InetAddresses#isNumericAddress(String)}
     *             instead.
     */
    @Deprecated
     ...
     */
    private static final String IRI_LABEL = "[" + LABEL_CHAR + "](?:[" + LABEL_CHAR + "_\\-]{0,61}[" + LABEL_CHAR
            + "]){0,1}";
    ...
    private static final String DOMAIN_NAME_STR = "(" + HOST_NAME + "|" + IP_ADDRESS_STRING + "|" + "localhost" + ")";
     ...
     */
    private static final String RELAXED_DOMAIN_NAME = "(?:" + "(?:" + IRI_LABEL + "(?:\\.(?=\\S))" + "?)+" + "|"
            + IP_ADDRESS_STRING + ")";
     ...
     */
    private static final String EMAIL_ADDRESS_LOCAL_PART = "[" + EMAIL_CHAR + "]" + "(?:[" + EMAIL_CHAR + "\\.]{0,62}["
            + EMAIL_CHAR + "])?";
     ...
     *                 extracted
     * @return         A String comprising all of the digits and plus in the
     *                 match
     */
